...
func IstioConfigDetails(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		// autogenerated objects do not exist in k8s, but can be retrieved as read only from registry
		istioConfigDetails, err = business.IstioConfig.GetIstioConfigDetailsFromRegistry(context.TODO(), namespace, objectType, object)
	}
