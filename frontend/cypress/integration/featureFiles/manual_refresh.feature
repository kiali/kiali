...
Feature: Kiali Istio Config page
  ...
  Scenario: Overview page shows manual
    Given user is at the "overview" page with manual refresh
    Then user "sees" manual refresh messaging

  Scenario: Graph page shows manual
    Given user is at the "graph" page with manual refresh
    Then user "sees" manual refresh messaging

Scenario: Applications page shows manual
    Given user is at the "applications" page with manual refresh
    Then user "sees" manual refresh messaging

Scenario: Services page shows manual
    Given user is at the "services" page with manual refresh
    Then user "sees" manual refresh messaging

Scenario: Workloads page shows manual
    Given user is at the "workloads" page with manual refresh
    Then user "sees" manual refresh messaging

Scenario: Istio page does not show manual
    Given user is at the "istio" page with manual refresh
    Then user "does not see" manual refresh messaging

Scenario: Mesh page shows manual
    Given user is at the "mesh" page with manual refresh
    Then user "sees" manual refresh messaging
