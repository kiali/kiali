...
test.describe('Apps list', () => {
  ...
  test('See all Apps objects in the bookinfo namespace @core-1', async ({ appsPage }) => {
  ...
  test('See all Apps toggles @core-1', async ({ appsPage }) => {
    await appsPage.expectAllAppsTogglesChecked();
  });

  test('Toggle Apps health toggle @core-1', async ({ appsPage }) => {
...
test.describe('Apps list health statuses', () => {
  ...
  test('The failing status of a logical mesh application is reported in the list @core-1', async ({
    appsPage,
    page,
    request
  }) => {
  ...
  test('The degraded status of a logical mesh application is reported in the list @core-1', async ({
    appsPage,
    page,
    request
  }) => {
