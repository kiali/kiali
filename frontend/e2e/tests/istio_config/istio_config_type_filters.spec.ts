...
test.describe('Istio Config type filters', () => {
  ...
  test('Fill the input form with nonsense', smokeCoreCaching, async ({ istioConfigPage }) => {
  ...
  test('Single filter should be usable', smokeCoreCaching, async ({ istioConfigPage }) => {
    await istioConfigPage.applyTypeFilter('AuthorizationPolicy');
  });

  test('Multiple filters should be usable', smokeCoreCaching, async ({ istioConfigPage }) => {
    await istioConfigPage.applyMultipleTypeFilters(['AuthorizationPolicy', 'DestinationRule']);
  });

  test('Filter AuthorizationPolicy should be deletable', smokeCoreCaching, async ({ istioConfigPage }) => {
    await istioConfigPage.applyTypeFilter('AuthorizationPolicy');
    await istioConfigPage.removeActiveFilter('AuthorizationPolicy');
  });

  test('Deleting all filters at once in config', smokeCoreCaching, async ({ istioConfigPage }) => {
    await istioConfigPage.applyTypeFilter('AuthorizationPolicy');
  ...
  test('Show the view of all type filters', smokeCoreCaching, async ({ istioConfigPage }) => {
    await istioConfigPage.chooseNTypeFilters(4);
    await istioConfigPage.showMoreFilters();
    await istioConfigPage.expectActiveFilterCount(4);
  });

  test('Hide the menu of all chosen filters', smokeCoreCaching, async ({ istioConfigPage }) => {
    await istioConfigPage.chooseNTypeFilters(4);
    await istioConfigPage.showMoreFilters();
    await istioConfigPage.expectActiveFilterCount(4);
