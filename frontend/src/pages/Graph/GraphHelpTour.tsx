...
export const GraphTourStops: { [name: string]: TourStopInfo } = {
  ContextualMenu: {
    name: $t('GraphTourStops.ContextualMenu.name', 'Contextual Menu'),
    description: $t(
      'GraphTourStops.ContextualMenu.description',
  ...
  ContextualMenuPF: {
    name: $t('GraphTourStops.ContextualMenuPF.name', 'Contextual Menu'),
    description: $t(
      'GraphTourStops.ContextualMenuPF.description',
  ...
  Display: {
    name: $t('GraphTourStops.Display.name'),
    description: $t(
      'GraphTourStops.Display.description',
  ...
  Find: {
    name: $t('GraphTourStops.Find.name', 'Find and Hide'),
    description: $t(
      'GraphTourStops.Find.description',
  ...
  Graph: {
    name: $t('GraphTourStops.Graph.name'),
    description: $t(
      'GraphTourStops.Graph.description',
  ...
  GraphPF: {
    name: $t('GraphTourStops.GraphPF.name'),
    description: $t(
      'GraphTourStops.GraphPF.description',
      'Click on a node or edge to see its summary and emphasize its end-to-end paths.'
    ),
    position: PopoverPosition.left,
    distance: 250
  },
  GraphTraffic: {
    name: $t('GraphTourStops.GraphTraffic.name', 'Graph Traffic'),
    description: $t(
      'GraphTourStops.GraphTraffic.description',
  ...
  GraphType: {
    name: $t('GraphTourStops.GraphType.name', 'Graph Type'),
    description: $t(
      'GraphTourStops.GraphType.description',
  ...
  Layout: {
    name: $t('GraphTourStops.Layout.name', 'Layout selection'),
    description: $t(
      'GraphTourStops.Layout.description',
  ...
  Legend: {
    name: $t('GraphTourStops.Legend.name'),
    description: $t(
      'GraphTourStops.Legend.description',
      'Display the legend to learn about what the different shapes, colors and backgrounds mean.'
    ),
    position: PopoverPosition.rightEnd
  },
  Namespaces: {
    name: $t('GraphTourStops.Namespaces.name'),
    description: $t('GraphTourStops.Namespaces.description', 'Select the namespaces you want to see in the graph.'),
    position: PopoverPosition.bottomStart
  },
  Shortcuts: {
    name: $t('GraphTourStops.Shortcuts.name', 'Shortcuts and tips...'),
    htmlDescription: GraphShortcuts,
    position: PopoverPosition.leftStart
  },
  SidePanel: {
    name: $t('GraphTourStops.SidePanel.name', 'Side Panel'),
    description: $t(
      'GraphTourStops.SidePanel.description',
      'The Side Panel shows details about the currently selected node or edge, otherwise the whole graph.'
    ),
    position: PopoverPosition.left
  },
  TimeRange: {
    name: $t('GraphTourStops.TimeRange.name', 'Time Range & Replay'),
    description: $t(
      'GraphTourStops.TimeRange.description',
