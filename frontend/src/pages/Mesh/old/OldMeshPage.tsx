...
const OldMeshPageComponent: React.FunctionComponent<MeshPageProps> = (props: MeshPageProps) => {
...
export const OldMeshPage = connect(mapStateToProps)(OldMeshPageComponent);
