...
import { getServiceWizardLabel } from '../../types/ServiceInfo';
import type { ServiceDetailsInfo, ServiceId } from '../../types/ServiceInfo';
import { filterAutogeneratedGateways, getGatewaysAsList, getK8sGatewaysAsList } from '../../types/IstioObjects';
import type { Gateway, K8sGateway, PeerAuthentication, Validations } from '../../types/IstioObjects';
    ...
    const servicePromise = API.getServiceDetail(
      ...
      .then(results => {
        publishChatResourceHealth(this.props.dispatch, {
          ...
          resourceName: this.props.serviceId.service
        });
        this.setState({
