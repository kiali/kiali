...
export enum URLParam {
  ...
  SERVICES_HIDDEN_COLUMNS = 'svchide',
  SERVICES_COLUMN_ORDER = 'svcorder',
  APPS_HIDDEN_COLUMNS = 'apphide',
  APPS_COLUMN_ORDER = 'apporder',
  WORKLOADS_HIDDEN_COLUMNS = 'wlhide',
  WORKLOADS_COLUMN_ORDER = 'wlorder',
  OVERVIEW_TYPE = 'otype',
