...
export const globalStyle = kialiStyle({
  ...
  $nest: {
    ...
    '& .pf-v6-c-tooltip a': {
      color:
        'var(pf-t--global--text--color--link--default)' /* CODEMODS: original v5 color was --pf-v6-global--link--Color--light */,
      $nest: {
        '&:hover': {
          color:
            'var(pf-t--global--text--color--link--hover)' /* CODEMODS: original v5 color was --pf-v6-global--link--Color--light--hover */
        }
      }
    },
