export enum ActionKeys {
  ...
  CHAT_AI_SET_CHAT_AI = 'CHAT_AI_SET_CHAT_AI',
  CHAT_AI_SET_CONTEXT = 'CHAT_AI_SET_CONTEXT',
  CHAT_AI_CLEAR_RESOURCE_HEALTH = 'CHAT_AI_CLEAR_RESOURCE_HEALTH',
  CHAT_AI_SET_RESOURCE_HEALTH = 'CHAT_AI_SET_RESOURCE_HEALTH',
  CHAT_AI_SET_CONVERSATION_ID = 'CHAT_AI_SET_CONVERSATION_ID',
  CHAT_AI_SET_SELECTED_PROVIDER = 'CHAT_AI_SET_SELECTED_PROVIDER',
  CHAT_AI_SET_SELECTED_MODEL = 'CHAT_AI_SET_SELECTED_MODEL',
  CHAT_AI_SET_CHAT_HISTORY_CLEAR = 'CHAT_AI_SET_CHAT_HISTORY_CLEAR',
  CHAT_AI_SET_CHAT_HISTORY_ADD = 'CHAT_AI_SET_CHAT_HISTORY_ADD',
  CHAT_AI_SET_CHAT_HISTORY_UPDATE_BY_ID = 'CHAT_AI_SET_CHAT_HISTORY_UPDATE_BY_ID',
  CHAT_AI_SET_CHAT_HISTORY_UPDATE_TOOL = 'CHAT_AI_SET_CHAT_HISTORY_UPDATE_TOOL',
  CHAT_AI_SET_QUERY = 'CHAT_AI_SET_QUERY',
  CHAT_AI_SET_OPEN_TOOL = 'CHAT_AI_SET_OPEN_TOOL',
  CHAT_AI_CLEAR_OPEN_TOOL = 'CHAT_AI_CLEAR_OPEN_TOOL',
  CHAT_AI_SET_DISPLAY_MODE = 'CHAT_AI_SET_DISPLAY_MODE',
  CHAT_AI_SET_ALWAYS_NAVIGATE = 'CHAT_AI_SET_ALWAYS_NAVIGATE',
  CHAT_AI_SET_INTERACTION_MODE = 'CHAT_AI_SET_INTERACTION_MODE',
  ...
  MESH_TOOLBAR_TOGGLE_KIALI = 'MESH_TOOLBAR_TOGGLE_SHOW_KIALI',
  ...
  NC_ADD_MESSAGE = 'NC_ADD_MESSAGE',
  NC_REMOVE_MESSAGE = 'NC_REMOVE_MESSAGE',
  NC_MARK_MESSAGE_AS_READ = 'NC_MARK_MESSAGE_AS_READ',
  NC_TOGGLE_MESSAGE_DETAIL = 'NC_TOGGLE_MESSAGE_DETAIL',
  NC_TOGGLE_EXPAND = 'NC_TOGGLE_EXPAND',
  NC_HIDE_NOTIFICATION = 'NC_HIDE_NOTIFICATION',
  ...
  NAMESPACES_LIST_SET_HIDDEN_COLUMNS = 'NAMESPACES_LIST_SET_HIDDEN_COLUMNS',
  NAMESPACES_LIST_SET_COLUMN_ORDER = 'NAMESPACES_LIST_SET_COLUMN_ORDER',

  SERVICES_LIST_SET_HIDDEN_COLUMNS = 'SERVICES_LIST_SET_HIDDEN_COLUMNS',
  SERVICES_LIST_SET_COLUMN_ORDER = 'SERVICES_LIST_SET_COLUMN_ORDER',

  APPS_LIST_SET_HIDDEN_COLUMNS = 'APPS_LIST_SET_HIDDEN_COLUMNS',
  APPS_LIST_SET_COLUMN_ORDER = 'APPS_LIST_SET_COLUMN_ORDER',

  WORKLOADS_LIST_SET_HIDDEN_COLUMNS = 'WORKLOADS_LIST_SET_HIDDEN_COLUMNS',
  WORKLOADS_LIST_SET_COLUMN_ORDER = 'WORKLOADS_LIST_SET_COLUMN_ORDER',
