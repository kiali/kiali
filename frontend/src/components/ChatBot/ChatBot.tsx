...
export const ChatBot: React.FC = () => {
  ...
  const conversationID = useSelector((state: KialiAppState) => state.ai.chat.conversationID);
  const chatHistory = useSelector((state: KialiAppState) => state.ai.chat.chatHistory);
