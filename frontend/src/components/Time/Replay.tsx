    ...
    '& .slider': {
      $nest: {
        '& .slider-selection.tick-slider-selection': {
          background:
            'var(--pf-t--temp--dev--tbd)' /* CODEMODS: original v5 color was --pf-v6-global--active-color--300 */ // should match PFColors.Replay
        },
      ...
      <div className={`${replayStyle} ${replayBorder}`}>
        ...
        <span className={sliderStyle}>
          ...
          <span className={controlStyle}>
            ...
            <Content component="p" className={frameStyle}>
              {this.formatFrame(this.state.replayFrame)}
            </Content>
