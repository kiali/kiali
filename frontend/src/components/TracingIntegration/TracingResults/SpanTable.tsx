...
const dangerErrorStyle = kialiStyle({
  borderLeft: 'var(--pf-t--temp--dev--tbd)' /* CODEMODS: original v5 color was --pf-v6-global--danger-color--100 */
});

const selectedErrorStyle = kialiStyle({
  borderRight: 'var(--pf-t--temp--dev--tbd)' /* CODEMODS: original v5 color was --pf-v6-global--info-color--100 */,
  borderLeft: 'var(--pf-t--temp--dev--tbd)' /* CODEMODS: original v5 color was --pf-v6-global--danger-color--100 */
});
