    ...
    await API.getWorkload(this.props.namespace, this.props.workloadName, params)
      .then(details => {
        this.setState({
          ...
          health: WorkloadHealth.fromJson(this.props.namespace, this.props.workloadName, details.data.health, {
      ...
      .catch(error => {
        ...
        const msg: ErrorMsg = {
          ...
          description: this.props.workloadName + ' is not found in the mesh'
        };
