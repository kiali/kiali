...
# This deploys the travel agency demo for istio 1.6 (and OSSM 2.0)
...
${CLIENT_EXE} -n istio-system get envoyfilter stats-filter-1.6-basic -o yaml > stats-filter-1.6.yaml
