...
hack/istio/install-istio-via-istioctl.sh --reduce-resources true --client-exe-path "$(which kubectl)" -cn "Kubernetes" -mid "mesh-default" -net "network-default" -gae "true"
