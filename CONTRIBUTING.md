...
If you want to add a new language or improve an existing one, you can check the internationalization section of the [README for UI](./frontend/README.adoc#internationalization-i18n) and the shared [i18n conventions guide](./I18N-AGENTS.md) for Spanish, French, and Chinese glossary/style rules.
