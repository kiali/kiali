...
type IstioClientInterface interface {
	...
	GetDeployments(namespace string, labelSelector string) (*v1beta1.DeploymentList, error)
	...
	GetServices(namespace string, selectorLabels map[string]string) (*v1.ServiceList, error)
