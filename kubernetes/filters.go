...
func FilterSupportedGateways(gateways []*networking_v1.Gateway) []*networking_v1.Gateway {
	filtered := []*networking_v1.Gateway{}
	for _, gw := range gateways {
		if gw.APIVersion == ApiNetworkingVersionV1 || gw.APIVersion == ApiNetworkingVersionV1Beta1 || gw.APIVersion == ApiNetworkingVersionV1Alpha3 {
			filtered = append(filtered, gw)
		}
	}
	return filtered
