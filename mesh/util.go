...
var StatusGetter func(context.Context, *config.Config, kubernetes.ClientFactory, cache.KialiCache, *grafana.Service, prometheus.ClientInterface) status.StatusInfo = status.Get
