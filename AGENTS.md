...
|-------|-------------|------|
| [Backend Architecture](docs/agents/backend-architecture.md) | Server startup, HTTP routing, handlers, and middleware pipeline | `docs/agents/backend-architecture.md` |
| [Business Logic Layer](docs/agents/business-logic.md) | Core service-mesh domain logic — apps, workloads, health, Istio config, mesh topology | `docs/agents/business-logic.md` |
| [Kubernetes Client Layer](docs/agents/kubernetes-client.md) | K8s/Istio API access, multi-cluster support, client factory, offline mode | `docs/agents/kubernetes-client.md` |
| [Graph Engine](docs/agents/graph-engine.md) | Traffic graph computation, appenders, telemetry pipelines, graph caching | `docs/agents/graph-engine.md` |
| [Observability Integrations and AI](docs/agents/observability-and-ai.md) | Distributed tracing (Jaeger/Tempo/OTel), Grafana, Perses, metrics, and AI Chat integration | `docs/agents/observability-and-ai.md` |
| [Authentication and Security](docs/agents/auth-and-security.md) | Authentication controllers (OpenID, token, OpenShift), JWT, mTLS/TLS policy | `docs/agents/auth-and-security.md` |
| [Frontend Architecture](docs/agents/frontend-architecture.md) | React/TypeScript frontend — component structure, routing, Redux state, PatternFly, i18n, Cypress tests | `docs/agents/frontend-architecture.md` |
| [Build System and Dev Conventions](docs/agents/build-and-dev-conventions.md) | Build system, CI/CD, cluster deployment, operator lifecycle, code standards, file protection rules | `docs/agents/build-and-dev-conventions.md` |

See [docs/agents/STATUS.md](docs/agents/STATUS.md) for freshness scores.
