...
type NodeData struct {
	...
	IsAutogenerated       bool                `json:"isAutogenerated,omitempty"`       // true (object is auto-generated from K8s API Gateway) | false
...
func buildConfig(trafficMap graph.TrafficMap, nodes *[]*NodeWrapper, edges *[]*EdgeWrapper, o graph.ConfigOptions) {
	for id, n := range trafficMap {
		...
		if val, ok := n.Metadata[graph.IsAutogenerated]; ok {
			nd.IsAutogenerated = val.(bool)
		}
