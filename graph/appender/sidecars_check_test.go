...
func TestAppNoPodsPasses(t *testing.T) {
	...
	businessLayer := setupSidecarsCheckWorkloads([]apps_v1.Deployment{}, []v1.Pod{})
...
func setupSidecarsCheckWorkloads(deployments []apps_v1.Deployment, pods []v1.Pod) *business.Layer {
