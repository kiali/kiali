...
func buildNamespaceTrafficMap(namespace string, o graph.TelemetryOptions, client *prometheus.Client) graph.TrafficMap {
	...
	*/
	...
	/* Istio no longer generates istio-to-istio destination-reported traffic.  We only care about ingress/egress which is reported in typical source telemetry
	if isIstioNamespace {
