...
=== LDAP Configuration
To configure authentication strategy to LDAP add the following configuration to the yaml file. If the auth strategy is LDAP. The application will not start without the basic LDAP settings like ldap_host, ldap_port, ldap_base and ldap_bind_dn.
