...
Please link:https://github.com/kiali/kiali/issues[open issues] for any bugs or problems you encounter or to suggest new features.
...
Get involved by submitting pull requests on GitHub.
...
If you do not have a JIRA account, you can also open issues here on GitHub (we are monitoring this as well).
...
If you pick one from the list, please let us know.
