...
Third, start Google Chrome and point the browser to the local URL for the Kiali GUI frontend started by yarn-start (in the example above, that will be `http://localhost:3001`).

Fourth, in Google Chrome, open the Developer Tools. You can press `F12` or `Control-Shift-I` to do this.
