...
KIALI_PROXY_URL ?= http://localhost:20001
...
OPERATOR_ALLOW_AD_HOC_CONTAINERS ?= true
OPERATOR_SECURITY_CONTEXT_OVERRIDE ?= true
...
help: Makefile
	...
	@echo
	@echo "MCP targets"
	@sed -n 's/^##//p' make/Makefile.mcp.mk | column -t -s ':' |  sed -e 's/^/ /'
	@echo
	@echo "Misc targets"
