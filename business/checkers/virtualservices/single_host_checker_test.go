...
func TestRepeatingSimpleHostWithGateway(t *testing.T) {
	...
	refKey := models.IstioValidationKey{ObjectType: kubernetes.VirtualServices.String(), Namespace: "bookinfo", Name: "virtual-2"}
	presentValidationTest(t, vals, "virtual-1")
...
func emptyValidationTest(t *testing.T, vals models.IstioValidations) {
	...
	validation, ok := vals[models.IstioValidationKey{ObjectType: kubernetes.VirtualServices.String(), Namespace: "bookinfo", Name: "virtual-1"}]
	assert.False(ok)
	assert.Nil(validation)

	validation, ok = vals[models.IstioValidationKey{ObjectType: kubernetes.VirtualServices.String(), Namespace: "bookinfo", Name: "virtual-2"}]
	assert.False(ok)
	assert.Nil(validation)
}
...
func noObjectValidationTest(t *testing.T, vals models.IstioValidations, name string) {
	...
	validation, ok := vals[models.IstioValidationKey{ObjectType: kubernetes.VirtualServices.String(), Namespace: "bookinfo", Name: name}]
	assert.False(ok)
	assert.Nil(validation)
}
...
func presentValidationTest(t *testing.T, vals models.IstioValidations, serviceName string) {
	...
	validation, ok := vals[models.IstioValidationKey{ObjectType: kubernetes.VirtualServices.String(), Namespace: "bookinfo", Name: serviceName}]
	assert.True(ok)
...
func presentReference(t *testing.T, validation models.IstioValidation, serviceName string) {
	assert := assert.New(t)
	refKey := models.IstioValidationKey{ObjectType: kubernetes.VirtualServices.String(), Namespace: "bookinfo", Name: serviceName}
...
func presentReferences(t *testing.T, validation models.IstioValidation, serviceNames []string) {
	...
	for _, sn := range serviceNames {
		refKey := models.IstioValidationKey{ObjectType: kubernetes.VirtualServices.String(), Namespace: "bookinfo", Name: sn}
		assert.Contains(validation.References, refKey)
	}
}
