...
func testValidationAdded(t *testing.T, destinationRules []networking_v1alpha3.DestinationRule, mTLSDetails kubernetes.MTLSDetails) *models.IstioValidation {
	assert := assert.New(t)
...
func testValidationsNotAdded(t *testing.T, destinationRules []networking_v1alpha3.DestinationRule, mTLSDetails kubernetes.MTLSDetails) {
	assert := assert.New(t)
