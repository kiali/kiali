...
func (n NoHostChecker) checkReference(refNamespace *k8s_networking_v1.Namespace, refName k8s_networking_v1.ObjectName, validations *[]*models.IstioCheck, location string) bool {
	...
	if strings.Contains(string(refName), ".") ||
		(namespace == n.K8sGRPCRoute.Namespace && !n.checkDestination(string(refName), namespace)) ||
		(namespace != n.K8sGRPCRoute.Namespace && (!n.checkReferenceGrant(n.K8sGRPCRoute.Namespace, namespace) || !n.checkDestination(string(refName), namespace))) {
