...
func (in *IstioValidationsService) filterVSExportToNamespaces(allNamespaces models.Namespaces, namespace string, cluster string, vs []*networking_v1.VirtualService) []*networking_v1.VirtualService {
	if namespace == "" {
...
func (in *IstioValidationsService) filterDRExportToNamespaces(allNamespaces models.Namespaces, namespace string, cluster string, dr []*networking_v1.DestinationRule) []*networking_v1.DestinationRule {
	if namespace == "" {
		return dr
	}
...
func (in *IstioValidationsService) filterSEExportToNamespaces(allNamespaces models.Namespaces, namespace string, cluster string, se []*networking_v1.ServiceEntry) []*networking_v1.ServiceEntry {
	if namespace == "" {
		return se
	}
...
func (in *IstioValidationsService) isExportedObjectIncluded(exportTo []string, meshExportTo []string, allNamespaces models.Namespaces, objectNamespace, exportedNamespace string, cluster string) bool {
