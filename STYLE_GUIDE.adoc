...
All fields in struct type definitions must be listed in alphabetical order. This applies to both public and private fields.
...
When initializing structs, use the same alphabetical field order:
