...
def __test_workload_health_deployment(kiali_client):
...
def __test_workload_health_replicaset(kiali_client):
...
def __test_service_health_deployment(kiali_client):
...
def __test_workload_health_invalid_replicaset_negative(kiali_client):
    workload_type = 'ReplicaSet'
    workload_name = 'details-v1'
...
def __test_workload_health_deployment_invalid_workload_negative(kiali_client):
...
def __test_workload_health_deployment_invalid_rateinterval_negative(kiali_client):
...
def __test_workload_health_deployment_invalid_type_invalid_rateinterval_negative(kiali_client):
...
def __test_workload_health_deployment_invalid_workload_invalid_type_negative(kiali_client):
...
def __test_workload_health_deployment_invalid_namespace_invalid_workload_negative(kiali_client):
...
def __test_workload_health_deployment_invalid_namespace_invalid_rateinterval_negative(kiali_client):
...
def __test_workload_health_deployment_invalid_namespace_invalid_type_negative(kiali_client):
...
def __test_workload_health_deployment_invalid_workload_invalid_rateinterval_negative(kiali_client):
...
def __test_workload_health_deployment_invalid_workload_invalid_query_param_negative(kiali_client):
...
def __test_workload_health_deployment_invalid_path_invalid_type_negative(kiali_client):
...
def __test_workload_health_deployment_invalid_namespace_invalid_query_param_negative(kiali_client):
...
def __test_workload_health_deployment_invalid_path_invalid_rateinterval_negative(kiali_client):
...
def __test_workload_health_deployment_invalid_path_invalid_query_param_negative(kiali_client):
...
def __test_workload_health_replica_set_invalid_namespace_negative(kiali_client):
...
def __test_workload_health_replica_set_invalid_rateinterval_negative(kiali_client):
...
def __test_workload_health_replica_set_invalid_type_invalid_rateinterval_negative(kiali_client):
...
def __test_workload_health_replica_set_invalid_workload_invalid_type_negative(kiali_client):
...
def __test_workload_health_replica_set_invalid_namespace_invalid_workload_negative(kiali_client):
...
def __test_workload_health_replica_set_invalid_namespace_invalid_rateinterval_negative(kiali_client):
...
def __test_workload_health_replica_set_invalid_namespace_invalid_type_negative(kiali_client):
...
def __test_workload_health_replica_set_invalid_workload_invalid_rateinterval_negative(kiali_client):
...
def __test_workload_health_replica_set_invalid_workload_invalid_query_param_negative(kiali_client):
...
def __test_workload_health_replica_set_invalid_path_invalid_type_negative(kiali_client):
...
def __test_workload_health_replica_set_invalid_namespace_invalid_query_param_negative(kiali_client):
...
def __test_workload_health_replica_set_invalid_path_invalid_rateinterval_negative(kiali_client):
...
def __test_workload_health_replica_set_invalid_path_invalid_query_param_negative(kiali_client):
